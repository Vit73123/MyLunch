...
* получить только те рестораны, у которых есть меню на сегодня.  
* получить только те рестораны, у которых есть меню на сегодня, и их меню.  

__Администраторы__ с объектами __Ресторан__ могут выполнять следующие действия:

* получить все рестораны, имеющиеся в базе данных;
* получить все рестораны, у которых есть меню на сегодня;
* получить все рестораны, у которых есть меню на сегодня, и их меню;
* получить все рестораны, у которых есть меню на указанную дату;
* получить все рестораны, у которых есть меню на указанную дату, и их меню;
...
* получить все блюда отдельного ресторана;
...
* получить меню отдельного ресторана на сегодня

Чтобы получить меню всех ресторанов, необходимо сделать запрос к объекту "ресторан" и получить все рестораны на сегодня и их меню.

__Администраторы__ с объектами __Меню__ могут выполнять следующие действия:

* получить отдельное меню отдельного ресторана
* получить меню отдельного ресторана на сегодня
* получить меню отдельного ресторана на заданную дату
* получить все меню отдельного ресторана за все дни
* создать новое меню данного ресторана на заданную дату
* удалить отдельное меню данного ресторана
* получить блюда отдельного меню данного ресторана
